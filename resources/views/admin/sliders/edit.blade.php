         ...
         <div class="card mb-4">
            ...
            <div class="card-body">
               ...
               <div class="mb-3">
                  ...
                  <div class="input-group">
                     <button 
                        id="button_post_imagesMobile" 
                        data-input="input_post_imagesMobile"
                        class="btn btn-outline-primary"
                        type="button">Browse
                     </button>
                     <input id="input_post_imagesMobile" 
                        name="image_mobile" 
                        value="{{ old('image_mobile_path',asset($slider->image_mobile_path) ) }}" 
                        type="text" 
                        class="form-control"
                        placeholder="" 
                        readonly />
