...
<div class="row">
   <div class="col-md-12">
      <form  action="{{  route('sliders.update', ['slider'=>$slider]) }}" method="POST">
         @csrf
         @method('PUT')
         <div class="card">
            <div class="card-body">
                  ...
                  <div class="col-md-8">
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           ...
                           <input id="input_post_imagesDesktop" name="image_desktop" value="{{ old('image_desktop_path',asset($slider->image_desktop_path) ) }}" type="text" class="form-control"
                              placeholder="" readonly />
                        </div>
                     </div>
                     <!-- thumbnail -->
                     <div class="form-group">
                        <label for="input_post_imagesMobile" class="font-weight-bold">
                           Images For Mobile
                        </label>
                        <div class="input-group">
                           <div class="input-group-prepend">
                           ...
                           <input id="input_post_imagesMobile" name="image_mobile" value="{{ old('image_mobile_path',asset($slider->image_mobile_path) ) }}" type="text" class="form-control"
                              placeholder="" readonly />
                        </div>
                     </div>
                     <!-- description -->
                     <div class="form-group">
                        ...
                        <textarea id="input_post_description" name="description" class="form-control @error('description') is-invalid @enderror" rows="20">{{ old('description', $slider->desc) }}</textarea>
                     </div>
                     @error('description')
                           <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
