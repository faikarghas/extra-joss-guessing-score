            ...
            <div class="basis-full lg:basis-[100%] relative">
                ...
                <form method="POST" action="{{ route('password.update') }}">
                  ...
                  <div class="relative z-0 mb-6 w-full group">
                        ...
                        <input type="email" name="email" id="email" class="font-sans block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2  focus:outline-none focus:ring-0 focus:border-black-600 peer"  required value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                  </div>
                  <div class="relative z-0 mb-6 w-full group">
                    <label for="email" class="block mb-2 text-sm font-medium text-[#A0A0A0] dark:text-gray-300">PASSWORD</label>
                    <input type="password" name="password" id="password" class="font-sans block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2  focus:outline-none focus:ring-0 focus:border-black-600 peer" placeholder="name@example.com" required  autofocus>
                  </div>
                  <div class="relative z-0 mb-6 w-full group">
